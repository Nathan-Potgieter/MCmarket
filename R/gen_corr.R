#' @title gen_corr
#' @description This function allows users to easily generate ad hoc correlation matrices with a set number of clusters and up to 4 layers.
...
#' @param Num_Clusters if Clusters = "non-overlapping" or Clusters = "none" then Num_Clusters is an integer value specifying the number of clusters. If Clusters = "overlapping" then Num_Clusters must be a vector, arranged in descending order, of length equal to Num_Layers specifying the number of clusters per layer.
